...
export const recipesLevelExpansion3: Recipe[] = [
  // ===== 무 =====
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '무는 단단하고 묵직한 것을 고르세요.',
      miseEnPlace: '갈비는 찬물에 1시간 담가 핏물을 빼 준비하세요.',
      cookware: { recommended: '냄비', alternatives: ['압력솥으로 시간을 줄일 수 있어요.'] },
      chefsNotes: '배(또는 사과)를 갈아 넣으면 천연 효소가 고기를 더 부드럽게 만들어줘요.',
      platingAndServing: '그릇에 담아 뜨겁게 서빙하세요.',
      pairing: '하루 묵혀서 다시 데우면 양념이 더 깊게 배어들어요.',
      storageAndReheating: '냉장 4~5일, 냉동 한 달 정도 가능해요.',
      leftoverIdeas: '국물에 당면을 넣어 끓이면 또 다른 한 끼가 돼요.',
      closingNote: '핏물을 충분히 빼는 것이 이 조림의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '무는 단단하고 묵직한 것을 고르세요.',
      miseEnPlace: '무는 두툼하게 썰어 모서리를 다듬어 준비하세요.',
      cookware: { recommended: '냄비', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '다시육수에 오래 끓여야 무 속까지 간이 배어들어요.',
      platingAndServing: '그릇에 담고 미소소스를 끼얹어 완성하세요.',
      pairing: '유자껍질을 올리면 향이 더 살아나요.',
      storageAndReheating: '냉장 2일, 데워서 드세요.',
      leftoverIdeas: '남은 육수는 국물요리에 활용해도 좋아요.',
      closingNote: '무를 오래 끓이는 것이 이 요리의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '관자는 크고 탱탱한 것을, 무는 단단한 것을 고르세요.',
      miseEnPlace: '관자는 물기를 완전히 제거해 준비하세요.',
      cookware: { recommended: '팬', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '관자는 만지지 말고 한 번만 뒤집어야 육즙이 보존돼요.',
      platingAndServing: '무 콩포트 위에 관자를 올려 완성하세요.',
      pairing: '허브오일을 살짝 곁들이면 좋아요.',
      storageAndReheating: '바로 먹는 게 가장 맛있어요.',
      leftoverIdeas: '남으면 다음날 데워서 그대로 즐겨도 좋아요.',
      closingNote: '관자를 짧게 시어링하는 것이 이 요리의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  // ===== 알배추 =====
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '알배추는 속이 꽉 찬 것을 고르세요.',
      miseEnPlace: '배추는 다져서 소금에 절여 물기를 빼 준비하세요.',
      cookware: { recommended: '찜기', alternatives: ['만두피를 사서 쓰면 간편해요.'] },
      chefsNotes: '배추의 물기를 충분히 짜야 만두가 질척이지 않아요.',
      platingAndServing: '접시에 담고 간장을 곁들이세요.',
      pairing: '식초간장에 찍어 먹으면 산뜻해요.',
      storageAndReheating: '냉동 보관 후 쪄서 드세요.',
      leftoverIdeas: '남으면 만둣국에 활용해도 좋아요.',
      closingNote: '배추 물기를 짜는 것이 이 만두의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '알배추는 속이 꽉 차고 신선한 것을 고르세요.',
      miseEnPlace: '배추는 가늘게 채 썰어 준비하세요.',
      cookware: { recommended: '유리병 또는 항아리', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '소금과 배추를 치대야 수분이 나와 발효가 시작돼요.',
      platingAndServing: '작은 접시에 덜어 곁들이세요.',
      pairing: '소시지나 훈제고기에 곁들이면 좋아요.',
      storageAndReheating: '냉장 몇 달 이상 보관 가능해요.',
      leftoverIdeas: '남으면 샌드위치에 곁들여도 좋아요.',
      closingNote: '배추를 충분히 치대는 것이 발효의 시작을 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '알배추는 잎이 크고 부드러운 것을 고르세요.',
      miseEnPlace: '배추잎은 데쳐서 물기를 제거해 준비하세요.',
      cookware: { recommended: '냄비, 팬', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '배추잎이 찢어지지 않게 부드럽게 데치는 것이 중요해요.',
      platingAndServing: '롤을 잘라 소스를 끼얹어 완성하세요.',
      pairing: '들깨크림소스가 고소함을 더해줘요.',
      storageAndReheating: '냉장 1일, 데워서 드세요.',
      leftoverIdeas: '남으면 다음날 데워서 그대로 즐겨도 좋아요.',
      closingNote: '배추잎을 부드럽게 데치는 것이 이 롤의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  // ===== 배 =====
  {
    ...
    masterclass: {
      ...
      miseEnPlace: '배는 얇게 슬라이스해 준비하세요.',
      cookware: { recommended: '없음', alternatives: ['따로 조리도구가 필요 없어요.'] },
      chefsNotes: '고르곤졸라는 향이 강하니 소량씩 올리세요.',
      platingAndServing: '접시에 담고 견과류를 뿌려 완성하세요.',
      pairing: '꿀을 살짝 뿌리면 단맛이 살아나요.',
      storageAndReheating: '만든 즉시 드세요.',
      leftoverIdeas: '남으면 다음날 빵에 곁들여도 좋아요.',
      closingNote: '치즈의 양을 조절하는 것이 이 샐러드의 균형을 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '배는 단단하고 아직 덜 익은 것을 고르세요.',
      miseEnPlace: '배는 껍질을 벗겨 통째로 준비하세요.',
      cookware: { recommended: '냄비', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '약불로 천천히 데워야 배 속까지 색과 향이 배어들어요.',
      platingAndServing: '접시에 담고 졸인 와인소스를 끼얹으세요.',
      pairing: '바닐라아이스크림을 곁들이면 좋아요.',
      storageAndReheating: '냉장 2~3일, 데워서 드세요.',
      leftoverIdeas: '남은 와인소스는 다른 디저트에 활용해도 좋아요.',
      closingNote: '약불로 천천히 데우는 것이 이 디저트의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '배는 과즙이 풍부하고 단단한 것을 고르세요.',
      miseEnPlace: '배는 얇게 저밀 수 있게 차갑게 준비하세요.',
      cookware: { recommended: '만돌린 또는 예리한 칼', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '배를 얇게 저밀수록 이 요리의 완성도가 높아져요.',
      platingAndServing: '접시에 겹쳐 담고 고르곤졸라와 발사믹을 뿌리세요.',
      pairing: '가벼운 화이트와인과 잘 어울려요.',
      storageAndReheating: '만든 즉시 드세요.',
      leftoverIdeas: '남으면 다음날 샐러드에 활용해도 좋아요.',
      closingNote: '배를 얇게 저미는 것이 이 전채의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  // ===== 고구마 =====
  {
    ...
    masterclass: {
      ...
      miseEnPlace: '고구마는 얇게 슬라이스해 준비하세요.',
      cookware: { recommended: '오븐용 그릇, 오븐', alternatives: ['에어프라이어로도 만들 수 있어요.'] },
      chefsNotes: '고구마를 균일한 두께로 썰어야 고르게 익어요.',
      platingAndServing: '뜨거울 때 바로 서빙하세요.',
      pairing: '치즈를 더 올리면 더 진한 맛이 나요.',
      storageAndReheating: '냉장 2일, 오븐에 데우세요.',
      leftoverIdeas: '남으면 다음날 데워서 그대로 즐겨도 좋아요.',
      closingNote: '고구마를 균일하게 써는 것이 이 그라탕의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '고구마는 묵직하고 단단한 것을 고르세요.',
      miseEnPlace: '고구마는 삶아서 으깨 준비하세요.',
      cookware: { recommended: '오븐용 그릇, 오븐', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '마시멜로는 겉만 살짝 그을리듯 구워야 예뻐요.',
      platingAndServing: '뜨거울 때 바로 서빙하세요.',
      pairing: '피칸을 뿌리면 고소함이 더해져요.',
      storageAndReheating: '냉장 2일, 오븐에 데우세요.',
      leftoverIdeas: '남으면 다음날 데워서 그대로 즐겨도 좋아요.',
      closingNote: '마시멜로를 살짝만 그을리는 것이 이 캐서롤의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '고구마는 단맛이 진한 것을, 두부는 단단한 것을 고르세요.',
      miseEnPlace: '두부는 물기를 완전히 제거해 준비하세요.',
      cookware: { recommended: '팬, 블렌더', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '두부는 만지지 말고 한 번만 뒤집어야 겉면이 바삭해요.',
      platingAndServing: '퓌레 위에 두부를 올려 완성하세요.',
      pairing: '허브오일을 살짝 곁들이면 좋아요.',
      storageAndReheating: '바로 먹는 게 가장 맛있어요.',
      leftoverIdeas: '남으면 다음날 데워서 그대로 즐겨도 좋아요.',
      closingNote: '두부를 바삭하게 시어링하는 것이 이 요리의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  // ===== 딸기 =====
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '딸기는 색이 진하고 향이 좋은 것을 고르세요.',
      miseEnPlace: '타르트지는 미리 구워 식혀 준비하세요.',
      cookware: { recommended: '타르트팬, 오븐', alternatives: ['머핀틀로 미니 타르트를 만들어도 좋아요.'] },
      chefsNotes: '커스터드크림은 완전히 식힌 뒤 채워야 타르트지가 눅눅해지지 않아요.',
      platingAndServing: '딸기를 소복이 올려 완성하세요.',
      pairing: '살구잼을 발라 광택을 내면 더 근사해요.',
      storageAndReheating: '냉장 2~3일 가능해요.',
      leftoverIdeas: '남으면 조각내어 도시락 디저트로 활용해도 좋아요.',
      closingNote: '커스터드를 충분히 식히는 것이 이 타르트의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      miseEnPlace: '스펀지케이크는 균일한 두께로 슬라이스해 준비하세요.',
      cookware: { recommended: '핸드믹서, 케이크틀', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '생크림은 너무 되직하지 않게 부드러운 뿔이 서는 정도로 휘핑하세요.',
      platingAndServing: '딸기를 켜켜이 넣고 겉면도 장식해 완성하세요.',
      pairing: '차와 함께 다과로 좋아요.',
      storageAndReheating: '냉장 2일 이내로 드세요.',
      leftoverIdeas: '남으면 다음날 그대로 즐기세요.',
      closingNote: '생크림을 가볍게 휘핑하는 것이 이 케이크의 완성도를 결정해요.',
    },
    ingredients: [
  ...
  },
  {
    ...
    masterclass: {
      ...
      ingredientSelection: '딸기는 잘 익어 향이 진한 것을 고르세요.',
      miseEnPlace: '딸기는 곱게 갈아 준비하세요.',
      cookware: { recommended: '면포, 체', alternatives: ['따로 대체 도구는 없어요.'] },
      chefsNotes: '짜지 말고 자연스럽게 흘러내리게 걸러야 맑게 정제돼요.',
      platingAndServing: '투명한 유리잔에 담아 바질잎을 올려 완성하세요.',
      pairing: '민트잎을 곁들여도 좋아요.',
      storageAndReheating: '냉장 2일 이내로 드세요.',
      leftoverIdeas: '거르고 남은 과육은 스무디에 활용해도 좋아요.',
      closingNote: '짜지 않고 자연스럽게 거르는 것이 이 콩소메의 완성도를 결정해요.',
    },
    ingredients: [
