...
export const recipesQ3Extra2: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      { name: '쌀', amount: '1컵' },
      { name: '메주콩', amount: '1/2컵' },
      { name: '물', amount: '1과 1/4컵' },
      { name: '소금', amount: '약간' },
    ],
    steps: [
