...
export const recipesIngredientCoverage: Recipe[] = [
  ...
  },
  {
    ...
    steps: [
      { title: '손질', description: '꽃게는 솔로 씻어 등딱지를 떼고 4등분합니다.' },
      { title: '육수', description: '물에 무를 넣고 끓이다 된장과 고추장을 풀어줍니다.' },
      { title: '끓이기', description: '꽃게와 다진마늘, 청양고추를 넣고 15분간 끓입니다.', timerSeconds: 900, tip: '거품을 걷어내면 국물이 더 맑아요.' },
    ],
    tips: ['꽃게는 등딱지에 알이 있으면 따로 모아 넣으면 국물이 더 진해져요.', '칼국수 사리를 더하면 든든한 한끼가 돼요.'],
  ...
  },
  {
    ...
    steps: [
      { title: '양념장', description: '간장, 맛술, 설탕, 다진마늘을 섞어 양념장을 끓여 졸입니다.' },
      { title: '굽기 1차', description: '장어를 석쇄나 팬에 먼저 노릇하게 굽습니다.', timerSeconds: 600 },
      { title: '양념 바르기', description: '양념장을 발라가며 2~3번 더 구워 윤기나게 마무리합니다.' },
    ],
    tips: ['생강채를 곁들이면 느끼함이 잡혀요.', '깻잎에 싸먹으면 더 깔끔해요.'],
  ...
  },
  {
    ...
    steps: [
      ...
      { title: '설탕 절이기', description: '설탕을 넣고 30분 정도 절여 즙이 나오게 합니다.' },
      { title: '졸이기', description: '냄비에 넣고 중약불에서 저어가며 20분간 졸입니다.', timerSeconds: 1200, tip: '레몬즙을 마지막에 넣으면 색과 산미가 살아요.' },
    ],
    tips: ['소독한 유리병에 담아 식혀 보관하면 오래 즐길 수 있어요.', '요거트에 곁들이면 잘 어울려요.'],
  ...
  // ===== 곡물 =====
  {
    ...
    steps: [
      { title: '불리기', description: '검은콩은 미리 1시간 정도 물에 불립니다.' },
      { title: '안치기', description: '씻은 쌀과 불린 콩을 솥에 담고 물을 맞춥니다.' },
      { title: '밥짓기', description: '평소처럼 밥을 짓습니다.', timerSeconds: 1800 },
    ],
    tips: ['콩을 안 불려도 되지만 불리면 더 부드러워요.', '소금을 약간 더하면 콩 맛이 살아나요.'],
