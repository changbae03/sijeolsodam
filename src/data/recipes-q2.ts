...
export const recipesQ2: Recipe[] = [
  ...
  // ===== 6월 =====
  {
    ...
    steps: [
      { title: '감자 손질', description: '햇감자는 껍질째 깨끗이 씻어 반으로 자릅니다.' },
      { title: '예열', description: '오븐을 200도로 예열합니다.' },
      { title: '버무리기', description: '감자에 올리브오일, 다진 마늘, 로즈마리, 소금, 후추를 넣고 골고루 버무립니다.' },
      { title: '굽기', description: '오븐 팬에 펼쳐 담아 200도에서 25분간 노릇하게 굽습니다.', timerSeconds: 1500, tip: '중간에 한 번 뒤집어주면 더 골고루 익어요.' },
    ],
    tips: [
