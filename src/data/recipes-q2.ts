...
export const recipesQ2: Recipe[] = [
  ...
  },
  {
    ...
    masterclass: {
      chefIntro:
        '6월의 햇감자를 손에 쥐어보면 알 거예요. 껍질이 얇아서 살짝 누르기만 해도 탱탱하게 되돌아오고, 흙 사이로 비치는 속살은 거의 우윳빛이에요. 캐낸 지 며칠 안 된 감자라 수분이 아직 넉넉하고, 전분은 채 자리를 잡기 전이거든요. 그래서 맛이 깨끗해요. 폼므 안나는 이 깨끗한 맛을 가릴 만한 어떤 재료도 쓰지 않는 요리예요. 버터와 소금, 그게 전부입니다. 양념도, 향신료도, 채소도 없어요. 그러니 평소 마트에서 사 오는 저장 감자보다, 지금 이 계절의 햇감자로 만들 때 그 차이가 훨씬 또렷하게 느껴져요. 손이 많이 가는 요리라는 건 솔직히 말씀드릴게요. 슬라이스하는 데만 10분, 굽는 데 1시간 가까이 걸려요. 그래도 한 번쯔음은 "감자 하나로 이렇게까지 만들 수 있구나" 싶은 경험을 드리고 싶었어요. 처음 만드는 거라면 더더욱, 천천히 함께 가보죠.',
      ingredientSelection:
        '감자를 고를 때 가장 먼저 보셔야 할 건 품종이에요. 전분이 적고 수분이 많은 "왁시(waxy)" 품종이 이 요리엔 제격이거든요. 한국 마트에서 가장 흔히 보이는 수미감자는 사실 전분질이 좀 강한 편이라, 평소라면 폼므 안나에 그다지 좋은 선택이 아니에요. 삶으면 잘 부서지니까요. 그런데 햇감자 철에는 이야기가 달라져요. 아직 전분이 충분히 여물지 않은 상태라, 의외로 다루기가 좋아요. 매대에서 감자를 집을 땐 크기를 맞춰 고르세요 — 비슷한 크기끼리 모아야 나중에 슬라이스 두께도 자연스럽게 맞춰지거든요. 표면을 한 번 쓸어보세요. 만졌을 때 단단하고, 푸르스름한 빛이나 싹이 튀어나온 자리가 없는 것으로요. 그 푸른빛은 솔라닌이라는 성분이 생기고 있다는 신호라, 맛도 쓰고 몸에도 좋지 않아요. 혹시 마트에 햇감자가 없다면 일반 감자로도 만들 수는 있어요. 다만 평소보다 더 신경 써서 얇게, 균일하게 썰어주셔야 해요.',
      miseEnPlace:
        '"미즈 앙 플라스"라는 말, 어렵게 들리지만 별 게 아니에요. 요리를 시작하기 전에 필요한 모든 걸 손 닿는 자리에 미리 꺼내두는 일, 그게 다예요. 이 요리에서는 특히 중요해요. 한 번 슬라이스를 시작하면 중간에 멈춰서 도구를 찾으러 갈 시간이 없거든요. 그러니 시작 전에 이렇게 준비해두세요. 버터는 약불에 녹여 정제까지 미리 끝내두고요(약불이 어떤 느낌인지 감이 안 오신다면, 가스불 눈금에서 가장 작은 칸 정도, 냄비 바닥이 천천히 따뜻해지는 정도면 충분해요). 만돌린 슬라이서를 쓰신다면, 손가락을 보호하는 안전 가드가 제대로 끼워져 있는지 한 번 더 확인하세요 — 이 도구는 정말 잘 베이거든요. 감자 무게보다 무거운 냄비나 내열 접시도 미리 옆에 꺼내두시고요. 오븐은 190도로 예열을 시작해두세요, 예열에도 시간이 걸리니까요. 이렇게 다 준비해두고 나서 감자를 썰기 시작하셔야, 썰어둔 감자가 마르거나 변색되기 전에 곧장 다음 단계로 넘어갈 수 있어요.',
      cookware: {
