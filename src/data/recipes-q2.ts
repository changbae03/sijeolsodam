...
export const recipesQ2: Recipe[] = [
  ...
  },
  {
    ...
    masterclass: {
      chefIntro:
        '6월의 햇감자를 손에 쥐어보면 알 거예요. 껍질이 얇아서 살짝 누르기만 해도 탱탱하게 되돌아오고, 흙 사이로 비치는 속살은 거의 우윳빛이에요. 캐낸 지 며칠 안 된 감자라 수분이 아직 넉넉하고, 전분은 채 자리를 잡기 전이거든요. 그래서 맛이 깨끗해요.\n\n폼므 안나는 이 깨끗한 맛을 가릴 만한 어떤 재료도 쓰지 않는 요리예요. 버터와 소금, 그게 전부입니다. 양념도, 향신료도, 채소도 없어요. 그러니 평소 마트에서 사 오는 저장 감자보다, 지금 이 계절의 햇감자로 만들 때 그 차이가 훨씬 또렷하게 느껴져요.\n\n손이 많이 가는 요리라는 건 솔직히 말씀드릴게요. 슬라이스하는 데만 10분, 굽는 데 1시간 가까이 걸려요. 그래도 한 번쯔음은 "감자 하나로 이렇게까지 만들 수 있구나" 싶은 경험을 드리고 싶었어요. 처음 만드는 거라면 더더욱, 천천히 함께 가보죠.',
      ingredientSelection:
        '감자를 고를 때 가장 먼저 보셔야 할 건 품종이에요. 전분이 적고 수분이 많은 "왁시(waxy)" 품종이 이 요리엔 제격이거든요. 한국 마트에서 가장 흔히 보이는 수미감자는 사실 전분질이 좀 강한 편이라, 평소라면 폼므 안나에 그다지 좋은 선택이 아니에요. 삶으면 잘 부서지니까요. 그런데 햇감자 철에는 이야기가 달라져요. 아직 전분이 충분히 여물지 않은 상태라, 의외로 다루기가 좋아요.\n\n매대에서 감자를 집을 땐 크기를 맞춰 고르세요 — 비슷한 크기끼리 모아야 나중에 슬라이스 두께도 자연스럽게 맞춰지거든요. 표면을 한 번 쓸어보세요. 만졌을 때 단단하고, 푸르스름한 빛이나 싹이 튀어나온 자리가 없는 것으로요. 그 푸른빛은 솔라닌이라는 성분이 생기고 있다는 신호라, 맛도 쓰고 몸에도 좋지 않아요.\n\n혹시 마트에 햇감자가 없다면 일반 감자로도 만들 수는 있어요. 다만 평소보다 더 신경 써서 얇게, 균일하게 썰어주셔야 해요.',
      miseEnPlace:
        '"미즈 앙 플라스"라는 말, 어렵게 들리지만 별 게 아니에요. 요리를 시작하기 전에 필요한 모든 걸 손 닿는 자리에 미리 꺼내두는 일, 그게 다예요. 이 요리에서는 특히 중요해요. 한 번 슬라이스를 시작하면 중간에 멈춰서 도구를 찾으러 갈 시간이 없거든요.\n\n그러니 시작 전에 이렇게 준비해두세요. 버터는 약불에 녹여 정제까지 미리 끝내두고요(약불이 어떤 느낌인지 감이 안 오신다면, 가스불 눈금에서 가장 작은 칸 정도, 냄비 바닥이 천천히 따뜻해지는 정도면 충분해요). 만돌린 슬라이서를 쓰신다면, 손가락을 보호하는 안전 가드가 제대로 끼워져 있는지 한 번 더 확인하세요 — 이 도구는 정말 잘 베이거든요. 감자 무게보다 무거운 냄비나 내열 접시도 미리 옆에 꺼내두시고요. 오븐은 190도로 예열을 시작해두세요, 예열에도 시간이 걸리니까요.\n\n이렇게 다 준비해두고 나서 감자를 썰기 시작하셔야, 썰어둔 감자가 마르거나 변색되기 전에 곧장 다음 단계로 넘어갈 수 있어요.',
      cookware: {
    ...
    steps: [
      {
        title: '균일하게 슬라이스',
        description:
          '감자는 껍질을 벗기고 만돌린이나 칼로 1.5~2mm로 가능한 균일하게 슬라이스합니다. 1.5mm가 어느 정도인지 감이 잘 안 오신다면, 10원짜리 동전 두께 정도를 떠올리시면 돼요. 재료가 이렇게 단순한 요리일수록, 사실은 기술이 곧 맛이에요. 두께가 들쭉날쭉하면 익는 속도도 자연히 따라 달라지고, 한참 뒤 팬을 뒤집는 순간 한쪽은 거의 타 있고 다른 한쪽은 아직 설익은, 당황스러운 결과를 마주하게 되거든요. 슬라이스를 하나씩 만질 때마다 살짝 휘어보세요. 부드럽게 흐느적거리지 않고, 탄력 있게 휘어졌다가 다시 펴지는 정도가 적당해요.',
        checkpoint: '슬라이스를 빛에 비춰보세요. 옅게 투과되는 정도면 적당하고, 만졌을 때 휘청거리지 않고 살짝 탄력 있게 휘어지면 두께가 맞은 거예요.',
        warning: '슬라이스 후 물에 씻으면 전분이 함께 빠져나가요. 켜를 서로 붙여줄 힘을 그대로 잃는 셈이니, 씻지 말고 바로 쓰세요.',
        recoveryTip: '이미 씻었다면 너무 걱정하지 마세요. 켜가 조금 덜 단단히 붙더라도, 굽는 시간을 5분 정도 늘려 더 오래 눌러주면 어느 정도는 보완할 수 있어요.',
      },
      {
        title: '버터 정제(선택)',
        description:
          '버터를 약불에 녹여 위에 뜨는 유단백을 걷어내면 정제 버터가 됩니다. 발연점이 일반 버터보다 높아서, 오래 구워도 타지 않고 맑은 황금빛을 끝까지 지켜줘요.',
        checkpoint: '녹인 버터를 가만히 두면 위에는 거품 섞인 흰 유단백이, 아래에는 투명한 황금빛 기름이 층을 나눠요. 고소한 버터향이 옅게 올라오면 다 된 거예요.',
        warning: '불을 세게 켜두면 유단백이 바닥에서 갈색으로 타며 쓴 냄새가 올라와요. 버터 녹이는 동안은 자리를 뜨지 마세요.',
        recoveryTip: '살짝 탔다면 그 부분만 숟가락으로 걷어내고 나머지 맑은 기름만 따로 따라 쓰면 괜찮아요.',
        tip: '시간이 부족하면 일반 버터로도 괜찮아요. 다만 불을 조금 더 자주 살펴보세요.',
      },
      {
        title: '팬에 쌓기',
        description:
          '무쇠팬 바닥에 버터를 바르고, 감자를 한 장씩 살짝 겹쳐가며 원을 그려 깝니다. 한 켜마다 버터를 얇게 발라주며 다섯에서 여섯 켜까지 쌓으세요. 나중에 단면을 갈랐을 때 보이는 그 결이, 바로 이 순서에서 만들어져요.',
        checkpoint: '첫 켜를 다 깔았을 때 틈이 안 보여야 해요. 빈틈이 있으면 그 자리가 약해서 뒤집을 때 거기서부터 갈라져요.',
        warning: '한 켜를 너무 두껍게(감자 두 장 겹쳐) 쌓으면 가운데가 설익어요. 한 켜는 항상 한 장 두께로 정리하세요.',
        recoveryTip: '쌓다가 빈틈을 발견했다면, 자투리 조각으로 그 자리만 메워주면 충분해요. 완벽한 원이 아니어도 괜찮아요.',
      },
      {
        title: '눌러 굽기',
        description:
          '팬을 약불에서 중불 사이에 올리고, 무거운 냄비나 접시로 누른 채 15분쯔음 굽습니다. 누르는 힘이 켜 사이의 공기를 밀어내고 서로를 압착시켜줘요. 이 과정 없이는, 뒤집는 순간 켜가 그대로 흩어집니다.',
        timerSeconds: 900,
        checkpoint: '팬 가장자리에서 버터가 자글자글 작은 소리로 끓고, 고소한 냄새가 옅게 퍼지기 시작하면 잘 진행되고 있는 거예요.',
        warning: '너무 세게 누르면 감자가 으깨지면서 즙이 빠져나와 바닥이 질척해져요. 적당한 무게로, 가만히 누르는 정도면 충분해요.',
        recoveryTip: '바닥이 너무 빨리 갈색이 된다면 불을 살짝 낮추세요. 속까지 익을 시간을 벌어주는 게 우선이에요.',
        tip: '무거운 게 마땅치 않다면 물을 채운 다른 냄비로도 같은 효과를 낼 수 있어요.',
      },
      {
        title: '오븐에서 마무리',
        description:
          '190도로 예열한 오븐에 옮겨 30분에서 40분 더 굽습니다. 이 시간 동안 부엌 전체에 변화가 일어나요. 처음 10분은 별다른 냄새가 안 나지만, 20분을 넘기면서부터 버터와 감자가 함께 익는 고소한 냄새가 부엌에 슬슬 퍼지기 시작해요. 오븐 문에 작은 창이 있다면 들여다보세요 — 팬 가장자리로 비치는 감자 옆면이 처음의 노란빛에서 점점 진한 갈색으로, 거의 카라멜에 가까운 색으로 바뀌어가는 게 보일 거예요. 그 색의 변화가 시간을 알려주는 가장 정확한 시계예요.',
        timerSeconds: 2100,
        checkpoint: '팬을 살짝 흔들었을 때 케이크가 통째로 움직이지 않고 바닥에서 살짝 미끄러지듯 반응하면, 아래까지 고르게 잘 구워진 거예요. 오븐 문을 열었을 때 버터 익는 향이 진하게 퍼지는 것도 좋은 신호예요.',
        warning: '불안한 마음에 자꾸 들여다보고 싶겠지만, 그때마다 아직 여린 켜 구조가 흔들려요. 옆면 색과 소리만으로 판단하고, 확인은 되도록 줄이세요.',
        recoveryTip: '한쪽만 색이 빨리 든다면 팬을 180도 돌려 나머지 5분을 채우면 고르게 맞춰져요.',
      },
      {
        title: '뒤집어 플레이팅',
        description:
          '팬보다 큰 접시를 덮어 한 번의 동작으로 뒤집습니다. 머뭇거리며 천천히 움직이면 그 틈에 부서지기 쉬워요. 망설이지 말고, 단번에.',
        checkpoint: '뒤집은 뒤 접시를 들어 올렸을 때 케이크가 매끈하게 분리되며 짙은 황금빛 바닥면이 그대로 드러나면, 성공이에요.',
        warning: '뒤집는 도중 손을 멈추거나 각도를 바꾸면 무게 중심이 흐트러져 가운데부터 갈라져요.',
        recoveryTip: '갈라졌다면 속상해하지 마세요. 부서진 조각들을 다시 모아 접시에 옮겨 담아도 맛은 똑같아요. 으깨듯 담아도 충분히 근사합니다.',
        tip: '뒤집기 전 팬 가장자리를 칼로 한 번 둘러보세요. 들러붙은 자리가 있는지 미리 확인하면 훨씬 안심이 돼요.',
      },
    ],
    tips: [
