...
export const recipesQ2: Recipe[] = [
  ...
  },
  {
    ...
    steps: [
      {
        title: '균일하게 슬라이스',
        description: '감자는 껍질을 벗기고 만돌린이나 칼로 1.5~2mm로 균일하게 슬라이스합니다(10원짜리 동전 두께). 두께가 다르면 익는 속도도 달라져 한쪽은 타고 한쪽은 설익어요.',
        checkpoint: '빛에 비춰 옅게 투과되고, 탄력 있게 휘어지면 적당해요.',
        warning: '씻으면 전분이 빠져 켜가 안 붙어요. 씻지 말고 바로 쓰세요.',
        recoveryTip: '씻었다면 굽는 시간을 5분 늘려 더 오래 눌러주세요.',
      },
      {
        title: '버터 정제(선택)',
        description: '버터를 약불에 녹여 위에 뜨는 유단백을 걷어내면 정제 버터가 됩니다. 발연점이 높아져 오래 구워도 안 타요.',
        ...
        tip: '시간이 없으면 일반 버터로도 괜찮아요.',
      },
      {
        title: '팬에 쌓기',
        description: '무쇠팬에 버터를 바르고 감자를 한 장씩 겹쳐 원을 그려 5~6켜까지 쌓습니다. 단면의 결이 여기서 만들어져요.',
        checkpoint: '첫 켜에 틈이 없어야 해요. 빈틈은 뒤집을 때 갈라지는 자리가 돼요.',
        warning: '두 장을 겹쳐 쌓으면 가운데가 설익어요.',
        recoveryTip: '빈틈은 자투리 조각으로 메우면 충분해요.',
      },
      {
        title: '눌러 굽기',
        description: '팬을 약불~중불에 올려 무거운 냄비로 누른 채 15분 굽습니다. 누르는 힘이 켜를 압착시켜, 안 누르면 뒤집을 때 흩어져요.',
        timerSeconds: 900,
        checkpoint: '버터가 작은 소리로 끓고 고소한 냄새가 옅게 퍼지면 잘 되고 있는 거예요.',
        warning: '너무 세게 누르면 즙이 빠져 바닥이 질척해져요.',
        recoveryTip: '바닥 색이 너무 빨리 진해지면 불을 낮추세요.',
        tip: '무거운 게 없으면 물 채운 냄비로 대신하세요.',
      },
      {
        title: '오븐에서 마무리',
        description: '190도 오븐에서 30~40분 더 굽습니다. 옆면이 노란빛에서 진한 갈색으로 바뀌는 게 가장 정확한 시계예요.',
        timerSeconds: 2100,
        checkpoint: '팬을 흔들었을 때 통째로 살짝 미끄러지면 다 구워진 거예요.',
        warning: '자꾸 들여다보면 여린 켜가 흔들려요. 색과 소리로만 판단하세요.',
        recoveryTip: '한쪽만 색이 빨리 들면 팬을 180도 돌리세요.',
      },
      {
        title: '뒤집어 플레이팅',
        description: '팬보다 큰 접시를 덮어 한 번에 뒤집습니다. 천천히 움직이면 그 틈에 부서져요.',
        checkpoint: '매끈하게 분리되며 황금빛 바닥면이 드러나면 성공이에요.',
        warning: '도중에 멈추거나 각도를 바꾸면 갈라져요.',
        recoveryTip: '갈라져도 맛은 같아요. 모아서 으깨듯 담으면 돼요.',
        tip: '뒤집기 전 팬 가장자리를 칼로 한 번 둘러보세요.',
      },
    ],
    tips: [
